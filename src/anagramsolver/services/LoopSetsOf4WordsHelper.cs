...
namespace anagramsolver.services
{
    public class LoopSetsOf4WordsHelper: LoopSetsBase
    {
        ...
        protected int LoopWordCombinationsInCurrentSet(int numberOfJackpots, CurrentSetOf4Pos currentSetLength, ref ulong combinationCounter, ref ulong subsetCounter)
        {
