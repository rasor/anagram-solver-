...
namespace anagramsolver.services
{
    public class LoopSetsOf4WordsHelper: LoopSetsBase
    {
        ...
        public int LoopSetsOf4WordsDoValidateAndCheckMd5(int numberOfJackpots, string[] remainingHashes)
        {
            ...
            {
                numberOfJackpots = Loop4WordCombinationsInCurrentSet(numberOfJackpots, currentSetLength, ref combinationCounter, ref subsetCounter);
            }
        ...
        private int Loop4WordCombinationsInCurrentSet(int numberOfJackpots, CurrentSetOf4Pos currentSetLength, ref ulong combinationCounter, ref ulong subsetCounter)
        {
